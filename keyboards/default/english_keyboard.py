...
english = ReplyKeyboardMarkup(
 keyboard=[
        ...
        [
            ...
            KeyboardButton(text='Co-learning(UZB)')
        ],
...
bigenner_key = ReplyKeyboardMarkup(
    keyboard=[
        [

            KeyboardButton(text='Davomi...'),
        ],
        [
...
elementry_key = ReplyKeyboardMarkup(
    keyboard=[
        [
            KeyboardButton(text='Davomi...'),
        ],
...
intermedet_key = ReplyKeyboardMarkup(
    keyboard=[
        [
            KeyboardButton(text='Davomi...'),
        ],
...
call_uzb_key = ReplyKeyboardMarkup(
    keyboard=[
        [
            KeyboardButton(text='Davomi...'),
        ],
